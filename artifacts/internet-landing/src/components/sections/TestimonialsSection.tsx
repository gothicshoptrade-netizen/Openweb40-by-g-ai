...
const testimonials = [
  ...
  },
  {
    ...
    text: "Подключили месяц назад. Скорость хорошая, сигнал стабильный даже в сильный мороз. Установка аккуратная. Немного долго ждал выезда замерщика, но в целом очень доволен.",
    hasVideo: false,
    videoThumb: "",
  },
];
