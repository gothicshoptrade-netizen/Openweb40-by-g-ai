...
const faqs = [
  {
    ...
    answer: "В среднем монтаж занимает 2–4 часа на объекте. Для большого дома или сложного рельефа — до одного рабочего дня. Выезд замерщика происходит в течение 24 часов. Итого: от заявки до интернета — 1–2 дня.",
  },
  {
  ...
  },
  {
    ...
    answer: "Наличные, карта (Visa, Mastercard, МИР), СБП, безналичный перевод для юрлиц. Рассрочка на оборудование до 12 месяцев. Ежемесячная абонентская плата — автоматически или вручную.",
  },
  {
  ...
  },
  {
    ...
    answer: "Техподдержка 24/7 для всех тарифов. Стандарт — телефон и email. Оптимальный — приоритетная поддержка, ответ за 30 мин. Максимум — персональный менеджер и удалённый мониторинг вашей сети в реальном времени.",
  },
];
